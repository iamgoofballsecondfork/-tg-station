...
/mob/living/silicon/ai/verb/pick_icon()
	...
	var/icontype = input("Please, select a display!", "AI", null/*, null*/) in list("Clown", "Monochrome", "Blue", "Inverted", "Firewall", "Green", "Red", "Static", "Red October","HAL")
	if(icontype == "Clown")
...
/mob/living/silicon/ai/proc/ai_statuschange()
	...
	if(usr.stat == 2)
		...
		return
	var/list/ai_emotions = list("Very Happy", "Happy", "Neutral", "Unsure", "Confused", "Sad", "BSOD", "Blank", "Problems?", "Awesome", "Facepalm", "Friend Computer","Dave")
